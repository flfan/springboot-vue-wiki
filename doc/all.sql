...
insert into ebook(id,name,description) values(3,'python 入门教程', 'python 入门开发,企业级应用开发最佳首选框架');
insert into ebook(id,name,description) values(4,'Mysql 入门教程', 'Mysql 入门开发,企业级应用开发最佳首选框架');
insert into ebook(id,name,description) values(5,'oracle 入门教程', 'oracle 入门开发,企业级应用开发最佳首选框架');